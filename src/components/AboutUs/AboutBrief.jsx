...
const AboutBrief = () => {
  return (
    <div>
        ...
        <div className="global-dedicated-infinite-scroll py-14 border-y-[1px] border-x-[#B7B7B7] overflow-x-hidden ">
            <div className="text-scroll-main-wrap flex gap-6">
                <div className="text-to-scroll-wrap text-[36px] flex items-center gap-6">
