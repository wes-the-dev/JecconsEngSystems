...
const AboutBrief = () => {
  return (
    <div>
        ...
        <div className="technicians-certs py-28 max-[650px]:py-20 max-[500px]:py-10 mx-32 max-[770px]:mx-10 max-[500px]:mx-5 mb-[100px] max-[770px]:mb-[40px] mt-[20px] ">
            <p className="text-center text-[32px] max-[650px]:text-[26px]">
        ...
        <div className="global-dedicated-infinite-scroll py-14 max-[770px]:py-8 border-y-[1px] border-x-[#B7B7B7] overflow-x-hidden ">
            <div className="text-scroll-main-wrap flex gap-6">
                <div className="text-to-scroll-wrap text-[36px] max-[770px]:text-[24px] flex items-center gap-6">
                    <div className="text-to-scroll flex items-center gap-6">
                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.5 9C1.5 5.72077 1.5 4.08116 2.31382 2.91891C2.6149 2.48891 2.98891 2.1149 3.41891 1.81382C4.58116 1 6.22077 1 9.5 1C12.7792 1 14.4188 1 15.5811 1.81382C16.0111 2.1149 16.3851 2.48891 16.6862 2.91891C17.5 4.08116 17.5 5.72077 17.5 9C17.5 12.2792 17.5 13.9188 16.6862 15.0811C16.3851 15.5111 16.0111 15.8851 15.5811 16.1862C14.4188 17 12.7792 17 9.5 17C6.22077 17 4.58116 17 3.41891 16.1862C2.98891 15.8851 2.6149 15.5111 2.31382 15.0811C1.5 13.9188 1.5 12.2792 1.5 9Z" stroke="#222222" stroke-width="1.5"/>
                        </svg>
                        <span>Global</span>
                    </div>
