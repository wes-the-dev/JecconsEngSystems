...
const MechEngHome = () => {
  ...
  return (
    <div className="mech-eng-home flex gap-6 items-center justify-between mb-28 max-[1000px]:mb-10">
        ...
        <div ref={refLeft} className="opacity-0 -translate-x-[20%] mech-eng-home-img flex items-center w-[50%] max-[1000px]:hidden">
            <img src={mechEngImg} alt="an engineer working" />
        </div>

        <Link to = "/mech-eng-services" className='w-[50%] max-[1000px]:w-[100%]'>
            <div ref={refRight} className="opacity-0 translate-x-[20%] mech-eng-summ cursor-pointer flex flex-col gap-4 max-[1000px]:w-[100%] my-auto h-fit">
