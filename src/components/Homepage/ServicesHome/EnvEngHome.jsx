  ...
  return (
    <div className="env-eng-home flex justify-between gap-10 mb-28 max-[1000px]:mb-10">
        <Link to = "/env-eng-services" className='w-[50%] max-[1000px]:w-[100%]'>
            <div ref={refLeft} className="opacity-0 -translate-x-[20%] env-eng-summ cursor-pointer flex flex-col gap-4 max-[1000px]:w-[100%] h-fit my-auto">
                ...
                <div className="flex flex-col gap-4">
                    <div ref={refHorizontalHeader} className="opacity-0 translate-y-[20%] env-eng-summ-title flex gap-3 max-[1000px]:justify-center max-[650px]:justify-start items-center">
        ...
        <div ref={refRight} className="opacity-0 translate-x-[20%] env-eng-home-img w-[50%] max-[1000px]:hidden flex justify-end">
            <img src={environEngImg} alt="engineers with a windmill model" />
        </div>
    </div>
  )
