...
const SecureSafeHome = () => {
  ...
  return (
    <div className="safe-secure-home flex gap-6 items-center justify-between mb-28 max-[1000px]:mb-10">
        ...
        <div ref={refLeft} className="opacity-0 -translate-x-[20%] safe-secure-home-img flex items-center w-[50%] max-[1000px]:hidden">
        ...
        <Link to = "/secure-safe-services" className='w-[50%] max-[1000px]:w-[100%]'>
            <div ref={refRight} className="opacity-0 translate-x-[20%] safe-secure-summ cursor-pointer flex flex-col gap-4 max-[1000px]:w-[100%] my-auto h-fit">
                ...
                <div className="flex flex-col gap-4">
                    <div ref={refHorizontalHeader} className="opacity-0 translate-y-[20%] mech-eng-summ-title flex gap-3 items-center max-[1000px]:justify-center max-[650px]:justify-start">
